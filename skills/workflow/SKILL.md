...
## Integration with R2 Stack

This skill is adapted from Brian Lovin's claude-config. Use in conjunction with:
- **CDO department skills** for design quality (taste-skill, deslop, simplify, rams)
- **TDD skill** for test-first development
- **Security reviewer agent** for pre-ship security audit
- **Self-improvement skill** for capturing lessons from corrections
