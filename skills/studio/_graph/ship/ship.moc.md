...
| Two-axis quality review | [[two-axis-review]] |
| Log and compound critique | [[taste-compounding]] |
...
Load [[visual-qa-loop]] and execute the screenshot → compare → fix loop.
Do not proceed until zero visual diffs remain.

Run: `./scripts/visual-qa.sh [URL]`

### Gate 2: Two-Axis Review
Load [[two-axis-review]] and score all 4 quadrants:
...
See [[taste-compounding]] for format.
...
- [[visual-qa-loop]] — screenshot → compare → fix loop (Gate 1)
- [[two-axis-review]] — 4-quadrant quality score, min 3/5 (Gate 2)

## Critique & Taste
- [[taste-compounding]] — critique log + weekly pattern promotion to anti-slop rules (Gate 3)
