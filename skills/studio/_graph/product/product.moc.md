...
feeds_into:
  ...
  - "task tracker entrys — product decisions get logged"
---
...
| Task | Load this |
|------|-----------|
| Raw idea → structured brief | [[braindump.moc]] |
| Write a full PRD | [[studio.product.prd.prd-outline]] |
| Prioritize features | [[studio.product.prioritization.rice]] |
| Plan roadmap | [[roadmap.moc]] |
| Pricing + launch | [[commercialization.moc]] |
| Define the problem first | [[studio.product.discovery.problem-framing]] |

## Sub-domains
- [[braindump.moc]] — classify brain dumps into bugs/features/strategy/questions
...
- [[roadmap.moc]] — Now/Next/Later planning
- [[commercialization.moc]] — pricing, GTM, launch strategy
